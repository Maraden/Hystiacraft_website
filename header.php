...
<header>
			<div class="brand" draggable="true">
				<img src="./images/Hystiacraft_Full_Text.png" class="header" draggable="false">
				...
				<div class="selects">
					...
					<div class="select forum-select">Forum		
						<div class="dropdown forum-dropdown">
							<a href="">Forum</a>
							<br>
							<a href="Badge.php">Liste des Badge</a>
						</div>
					</div>

					<div class="select cours-select">Projet
						<div class="dropdown cours-dropdown">
							<a href="projet/studio.php">Hystiacraft Studio</a>
							<br>
							<a href="projet/workshop.php">Hystiacraft Workshop</a>
						</div>
					</div>
					...
					<div class="dropdown login-dropdown">
                      <?php if (isset($_SESSION['id'])) {   ?> 
                      <?php if (isset($fetch['Rank']) && $fetch['Rank'] >= 8 || isset($fetch['Rank']) && $fetch['Rank'] >= 9 || isset($userinfo['Rank']) && $userinfo['Rank'] >= 8 || isset($userinfo['Rank']) && $userinfo['Rank'] >= 9){ ?>
                      	<a href="redaction.php" style="color:red">Rédaction</a>
                  <br>
                   <?php } ?>
